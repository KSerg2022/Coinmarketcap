...
class TestExBinance(unittest.TestCase, TestBase):
    ...
    @unittest.skip('do with api_key without permissions')
    def test_get_futures_coin_account_api_not_have_permissions(self):
        result = self.exchanger.get_futures_coin_account()
    ...
    @unittest.skip('do with api_key without permissions')
    def test_get_spot_account_api_not_have_permissions(self):
        result = self.exchanger.get_spot_account()
        self.assertEqual(result, {})
