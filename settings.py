...
# base currencies for query one by one
currencies_symbols_by_one = [
...
# currency wich is not on coinmarketcap.com now
currency_is_not_on_coinmarketcap = ['HINATA', 'RAZR',]